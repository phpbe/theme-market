...
class Config
{
     ...
     * )
     */
    public string $paddingMobile = '1rem 0 1rem 0';
     ...
     * )
     */
    public string $paddingTablet = '2rem 0 2rem 0';
     ...
     * )
     */
    public string $paddingDesktop = '3rem 0 3rem 0';

    /**
     * @BeConfigItem("子项",
     *     driver = "FormItemsConfigs",
     *     items = "return [
     *          \Be\Theme\Market\Section\Footer\Item\Contact::class,
     *          \Be\Theme\Market\Section\Footer\Item\Menu::class,
     *          \Be\Theme\Market\Section\Footer\Item\Subscribe::class,
     *          \Be\Theme\Market\Section\Footer\Item\RichText::class,
     *     ]"
     * )
     */
    public array $items = [

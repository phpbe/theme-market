...
class Template extends Section
{
    ...
    public function display()
    {
        ...
        echo '<div class="app-shop-categories">';
        if ($this->position === 'middle' && $this->config->width === 'default') {
            echo '<div class="be-container">';
        }

        if ($this->config->title !== '') {
            echo '<div class="app-shop-categories-title">';
        ...
        echo '<div class="app-shop-categories-items">';
        foreach ($categories as $category) {
            ...
            echo '<div class="app-shop-categories-item">';

            echo '<div class="be-ta-center app-shop-categories-item-image">';
    ...
    private function css()
    {
        ...
        echo $this->getCssBackgroundColor('app-shop-categories');
        echo $this->getCssPadding('app-shop-categories');
        echo $this->getCssMargin('app-shop-categories');

        echo '#' . $this->id . '{';
        echo '}';

        echo '#' . $this->id . ' .app-shop-categories {';
        echo '}';


        echo '#' . $this->id . ' .app-shop-categories-title {';
        echo 'margin-bottom: 2rem;';
        echo '}';

        echo '#' . $this->id . ' .app-shop-categories-title h3 {';
        ...
        echo '#' . $this->id . ' .app-shop-categories-title h3:before {';
        ...
        echo '#' . $this->id . ' .app-shop-categories-items {';
        echo 'display: flex;';
        echo 'flex-wrap: wrap;';
        //echo 'overflow: hidden;';
        echo '}';

        echo '#' . $this->id . ' .app-shop-categories-item {';
        echo 'flex: 0 1 auto;';
        //echo 'overflow: hidden;';
        echo 'min-width:0;';
        echo '}';
        ...
        echo '#' . $this->id . ' .app-shop-categories-item-image a {';
        echo 'display: block;';
        echo 'overflow:hidden;';
        echo '}';


        echo '#' . $this->id . ' .app-shop-categories-item-image img {';
        echo 'display: block;';
        echo 'width: 100%;';
        echo 'transition: all .3s;';
        echo '}';

        echo '#' . $this->id . ' .app-shop-categories-item-image img:hover  {';
